...
/* harmony export */ });
/* harmony import */ var _root_NTree__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../root/NTree */ "../src/root/NTree.ts");
/* harmony import */ var _styles_less__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./styles.less */ "../src/form/styles.less");


var tree = new _root_NTree__WEBPACK_IMPORTED_MODULE_0__.Tree({
  makeElement: function makeElement(tag) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _root_Tree__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./root/Tree */ "../src/root/Tree.ts");
/* harmony import */ var _form__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./form */ "../src/form/index.ts");
/* eslint-disable @typescript-eslint/ban-ts-comment */


(function main() {
  //@ts-ignore
  (0,_root_Tree__WEBPACK_IMPORTED_MODULE_0__.Root)((0,_form__WEBPACK_IMPORTED_MODULE_1__.Application)().node);
})();
...
var TreeFactory = /*#__PURE__*/function () {
    ...
    value: function getInstance(key) {
      ...
      if (this.instances[key]) {
        ...
        this.instances[key] = new Tree({
          makeElement: function makeElement(name) {
...
var Tree = /*#__PURE__*/function () {
  function Tree(opts, cleanFactory) {
    var _this2 = this;
    _classCallCheck(this, Tree);
    _defineProperty(this, "cleanFactory", null);
    _defineProperty(this, "elements", {});
    _defineProperty(this, "touchedElements", {});
    _defineProperty(this, "unmountRoot", function () {
      if (_this2.cleanFactory) {
        _this2.cleanFactory();
      }
      //@ts-ignore
      _this2.rootElement.node.remove();
      _this2.rootElement = undefined;
      _this2.elements = {};
    });
    _defineProperty(this, "updateAttributes", function (element) {
      var newAttributes = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      Object.keys(newAttributes).forEach(function (at) {
    ...
    _defineProperty(this, "updateEventListeners", function (element, newEventListeners) {
      if (!newEventListeners) {
        return;
      }
      Object.keys(newEventListeners).forEach(function (at) {
    ...
    _defineProperty(this, "mountNoneTextChilds", function (parentKey, parentTag, child) {
      if (Array.isArray(child)) {
        child.forEach(function (ch) {
          ...
          if (ch.isRoot) {
            _this2.touchedElements[ch.id] = true;
            _this2.elements[ch.id] = ch;
          }
          parentTag.appendChild(ch.node);
        });
      } else if (child.id) {
        if (child.isRoot) {
          _this2.touchedElements[child.id] = true;
          _this2.elements[child.id] = child;
        }
        child.parentId = parentKey;
        parentTag.appendChild(child.node);
      }
    });
    _defineProperty(this, "updateNoneTextChilds", function (oldElement, child) {
      if (!child) {
        return;
        //@ts-ignore
      } else if (child.id) {
        if (child.isRoot) {
          _this2.touchedElements[child.id] = true;
          _this2.elements[child.id] = child; // mount to tree
        }
        ...
        child.forEach(function (ch, index) {
          ...
          if (ch.isRoot) {
            _this2.touchedElements[ch.id] = true;
            _this2.elements[ch.id] = ch; // mount to tree
          }
          ...
          if (!ch.parentId) {
            ...
            if (!index) {
              ...
              var prevNode = child[lastNonNullIndex - 1].node;
  ...
  _createClass(Tree, [{
    ...
    value: function root(opts) {
      if (!this.rootElement) {
        this.mountRoot(opts.key, opts.child, opts.attributes, opts.eventListeners);
      } else {
    ...
    key: "tag",
    value: function tag(opts) {
      var elem;
      if (!this.elements[opts.key]) {
        elem = this.mountElement(opts.key, opts.tagName, opts.child, opts.attributes, opts.eventListeners);
        if (opts.getNode) {
          opts.getNode(elem.node);
        }
      } else {
        elem = this.updateElement(opts.key, opts.child, opts.attributes, opts.eventListeners);
      }
      this.touchedElements[opts.key] = true;
      return elem;
    }
  }, {
    key: "mountRoot",
    value: function mountRoot(key, child) {
      var attributes = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
      var eventListeners = arguments.length > 3 ? arguments[3] : undefined;
      var divElement = this.opts.makeElement('div');
      this.mountNoneTextChilds(key, divElement, child);
      ...
      this.rootElement = {
        isRoot: true,
        tagName: 'div',
        innerText: typeof child === 'string' ? child : null,
    ...
    key: "updateRoot",
    value: function updateRoot(child, attributes, eventListeners) {
      var oldElement = this.rootElement;
      this.updateNoneTextChilds(oldElement, child);
    ...
    key: "updateElement",
    value: function updateElement(key, child, attributes, eventListeners) {
      var oldElement = this.elements[key];
      this.updateNoneTextChilds(oldElement, child);
      this.updateAttributes(oldElement, attributes);
      this.updateEventListeners(oldElement, eventListeners);
      if (typeof child === 'string') {
    ...
    key: "mountElement",
    value: function mountElement(key, tagName, child, attributes, eventListeners) {
      var tagElement = this.opts.makeElement(tagName);
      this.mountNoneTextChilds(key, tagElement, child);
      if (typeof child === 'string') {
      ...
      this.updateEventListeners(this.elements[key], eventListeners);
      return this.elements[key];
    }
  }, {
    key: "unmountElement",
    value: function unmountElement(key) {
...
var Style = /*#__PURE__*/function () {
  function Style() {
    ...
    _defineProperty(this, "transformPropName", function (ksopt) {
      switch (ksopt) {
  ...
  _createClass(Style, [{
    key: "makeStyle",
    value: function makeStyle(sopt) {
      var data = '';
      for (var s in sopt) {
        data += "".concat(this.transformPropName(s), ": ").concat(sopt[s], ";\n");
      }
      return data;
    }
  }]);
...
/* harmony export */   "TreeFactory": () => (/* binding */ TreeFactory)
/* harmony export */ });
/* harmony import */ var _Style__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Style */ "../src/root/Style.ts");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
  ...
  _createClass(TreeFactory, [{
    ...
    value: function getInstance(key) {
      ...
      if (this.instances[key]) {
        ...
        this.instances[key] = new Tree(function () {
          delete _this.instances[key];
        });
        return this.instances[key];
      }
...
var Tree = /*#__PURE__*/function () {
  function Tree(cleanFactory) {
    ...
    _defineProperty(this, "updateNoneTextChilds", function (oldElement, child) {
      if (!child) {
        ...
        if (child.isRoot) {
          _this2.touchedElements[child.id];
          _this2.elements[child.id] = child; // mount to tree
        }
        ...
        child.forEach(function (ch, index) {
          ...
          if (ch.isRoot) {
            _this2.touchedElements.push(ch.id);
            _this2.elements[ch.id] = ch; // mount to tree
          }
  ...
  _createClass(Tree, [{
    ...
    key: "div",
    value: function div(opts) {
      var elem;
      var styleString = '';
      if (opts.style) {
        styleString = new _Style__WEBPACK_IMPORTED_MODULE_0__.Style().makeStyle(opts.style);
      }
      if (!this.elements[opts.key]) {
    ...
    key: "mountRoot",
    value: function mountRoot(key, child, style, onClick) {
      var _this3 = this;
      ...
      if (typeof child === 'string') {
        ...
        child.forEach(function (ch) {
          ...
          ch.parentId = key;
          if (ch.isRoot) {
            _this3.touchedElements[ch.id];
            _this3.elements[ch.id] = ch;
          }
    ...
    key: "updateRoot",
    value: function updateRoot(key, child, style, onClick) {
      var _this4 = this;
      var oldElement = this.rootElement;
      var text = typeof child === 'string' ? child : null;
      var isStyleChanged = style && style !== oldElement.attributes.style;
      var isTextChanged = text !== oldElement.attributes.innerText;
      if (isStyleChanged) {
      ...
      if (Array.isArray(child)) {
        ...
        child.forEach(function (ch, index) {
          ...
          if (ch.isRoot) {
            _this4.touchedElements[ch.id];
            _this4.elements[ch.id] = ch; // mount to tree
          }
    ...
    key: "updateElement",
    value: function updateElement(key, child, style, onClick) {
      var _this5 = this;
      var oldElement = this.elements[key];
      //this.findElement()
      var isStyleChanged = style !== oldElement.attributes.style;
      var text = typeof child === 'string' ? child : null;
      var isTextChanged = text !== oldElement.attributes.innerText;
      if (isStyleChanged) {
        oldElement.attributes.style = style;
      ...
      if (Array.isArray(child)) {
        ...
        child.forEach(function (ch, index) {
          ...
          if (ch.type === 'root') {
            _this5.touchedElements[ch.id];
            _this5.elements[ch.id] = ch; // mount to tree
          }
    ...
    key: "updateInput",
    value: function updateInput(key, value, style, onChange) {
      var oldInput = this.elements[key];
      if (style) {
    ...
    key: "mountInput",
    value: function mountInput(key, value, style, onChange) {
    ...
    key: "mountElement",
    value: function mountElement(key, child, style, onClick) {
      var _this6 = this;
      // this.elements[key] = child
      // create unique key
      var divElement = document.createElement('div');
      if (Array.isArray(child)) {
        child.forEach(function (ch) {
          ...
          ch.parentId = key;
          if (ch.isRoot) {
            _this6.touchedElements[ch.id];
            _this6.elements[ch.id] = ch;
          }
          divElement.appendChild(ch.node);
        });
...
/***/ "../node_modules/css-loader/dist/cjs.js!../node_modules/less-loader/dist/cjs.js!../src/form/styles.less":
/*!**************************************************************************************************************!*\
  !*** ../node_modules/css-loader/dist/cjs.js!../node_modules/less-loader/dist/cjs.js!../src/form/styles.less ***!
  \**************************************************************************************************************/
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body {\n  margin: 0;\n}\n.form-container {\n  height: 100vh;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n}\n.form-input {\n  margin: 20px;\n  width: 320px;\n  height: 40px;\n}\n.form-button {\n  border: box;\n  background-color: aqua;\n  margin: 20px;\n  width: 320px;\n  height: 40px;\n}\n", "",{"version":3,"sources":["webpack://./../src/form/styles.less"],"names":[],"mappings":"AACA;EACI,SAAA;AAAJ;AAIA;EACI,aAAA;EACA,aAAA;EACA,sBAAA;EACA,mBAAA;EACA,uBAAA;AAFJ;AAKA;EACI,YAAA;EACA,YAAA;EACA,YAAA;AAHJ;AAMA;EACI,WAAA;EACA,sBAAA;EACA,YAAA;EACA,YAAA;EACA,YAAA;AAJJ","sourcesContent":["\nbody {\n    margin: 0;\n}\n\n\n.form-container {\n    height: 100vh;\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n    justify-content: center;\n}\n\n.form-input {\n    margin: 20px;\n    width: 320px;\n    height: 40px;\n}\n\n.form-button {\n    border: box;\n    background-color: aqua;\n    margin: 20px;\n    width: 320px;\n    height: 40px;\n}\n"],"sourceRoot":""}]);
// Exports
...
if (true) {
  ...
  return true;
    ...
    module.hot.accept(
      /*! !!../../node_modules/css-loader/dist/cjs.js!../../node_modules/less-loader/dist/cjs.js!./styles.less */ "../node_modules/css-loader/dist/cjs.js!../node_modules/less-loader/dist/cjs.js!../src/form/styles.less",
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("83a72851d85fd3743af2")
/******/ 	})();
/******/ 	
...
/******/ 	var __webpack_exports__ = __webpack_require__("../src/root.ts");
/******/ 	
/******/ })()
;
