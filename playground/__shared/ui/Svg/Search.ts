  ...
  const closeElement = tree.tag(
    {
      tagName: 'path',
      attributes: {
        d: 'M11.047 18.992c-1.574-1.997-2.514-4.518-2.514-7.258 0-6.48 5.253-11.733 11.733-11.733s11.733 5.253 11.733 11.733c0 6.48-5.253 11.733-11.733 11.733-2.74 0-5.261-0.939-7.258-2.514l-9.050 9.050c-0.425 0.425-1.095 0.422-1.511 0.006l-0.456-0.456c-0.411-0.411-0.413-1.092 0.006-1.511l9.050-9.050zM20.267 20.693c4.948 0 8.96-4.012 8.96-8.96s-4.012-8.96-8.96-8.96c-4.948 0-8.96 4.012-8.96 8.96s4.012 8.96 8.96 8.96z',
      },
      child: null,
    },
    `${key}_close`
