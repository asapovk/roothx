...
export const Search = (tree: Tree | Tags, props, key) => {
  const closeElement = tree.tag(
    {
      tagName: 'path',
      attributes: {
        d: 'M16 14.037l-12.284-12.279c-0.154-0.154-0.367-0.249-0.603-0.249s-0.448 0.095-0.603 0.249l-0.755 0.755c-0.154 0.154-0.249 0.367-0.249 0.603s0.095 0.448 0.249 0.603l12.284 12.282-12.284 12.284c-0.154 0.154-0.249 0.367-0.249 0.603s0.095 0.448 0.249 0.603l0.755 0.755c0.154 0.154 0.367 0.249 0.603 0.249s0.448-0.095 0.603-0.249l12.284-12.284 12.284 12.284c0.154 0.154 0.367 0.249 0.603 0.249s0.448-0.095 0.603-0.249l0.755-0.755c0.154-0.154 0.249-0.367 0.249-0.603s-0.095-0.448-0.249-0.603l-12.284-12.284 12.284-12.284c0.154-0.154 0.249-0.367 0.249-0.603s-0.095-0.448-0.249-0.603l-0.755-0.755c-0.154-0.154-0.367-0.249-0.603-0.249s-0.448 0.095-0.603 0.249l-12.284 12.284z',
      },
      child: null,
    },
    `${key}_close`
